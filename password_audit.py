...
def risk_assessment(final_entropy_report, risk_points):
    if risk_points == 0:
        ...
        print("This password is consistent with the modern password guidance but still contains limitations that does not align with the NIST Password Guidance.\nConsider Resolving the limitations by mitigations mentioned below.\n")
        print('-'*75 + '')
...
def pass_audit(password):
    print("="*150)
    print(" "*60 +"PASSWORD AUDIT REPORT")
    print("="*150 + '\n')
